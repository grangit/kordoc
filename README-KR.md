...
interface ParseResult {
  ...
  isImageBased?: boolean     // 스캔 PDF 감지
  pageCount?: number         // PDF 전용
  error?: string
}
```
...
> 내부 타입(`IRBlock`, `IRTable`, `IRCell`, `CellContext`)과 유틸리티(`KordocError`, `sanitizeError`, `isPathTraversal`, `buildTable`, `blocksToMarkdown`)는 public API에 포함되지 않습니다.
